...
import { Store, TrendingUp, PieChart as PieChartIcon, ChevronDown } from "lucide-react";
                      ...
                      {hoveredItem ? (
                        <>
                          <Text
                            ...
                            fontWeight="600"
                            color={
                              STORE_COLORS[hoveredIdx! % STORE_COLORS.length]
                            }
                            lineHeight="short"
                            mb={0.5}
                          >
                  ...
                  return (
                    ...
                    >
                      <Box
                        ...
                        h={2.5}
                        borderRadius="sm"
                        bg={STORE_COLORS[idx % STORE_COLORS.length]}
                        flexShrink={0}
                      />
                      <Box flex={1} minW={0}>
                        <Text

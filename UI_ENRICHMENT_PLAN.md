...
- Show navigation breadcrumbs on every page: "Home > INR Ledger > HDFC Savings > Transactions". Helps users understand where they are and navigate up.
- **Key files:** `Layout.tsx`, each page component.
- **Backend changes:** None. Pure frontend routing metadata.
...
| 22 | Breadcrumb navigation | 11.2 | No |
